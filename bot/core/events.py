...
class Events(commands.Cog):
    ...
    async def on_guild_join(self, guild):
        ...
        if first_text_channel is not None:
            ...
            embed2 = discord.Embed(title="Информация",
            ...
            embed2.add_field(name="Поддержка",
                             ...
                             inline=False)
            embed2.add_field(name="Примечание",

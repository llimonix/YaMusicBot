from discord import Colour, Embed, ApplicationContext, ButtonStyle, ui, SelectOption
...
class HelpCommand(commands.Cog):
    ...
    @commands.slash_command(name="help", description="All existing bot commands",
                            description_localizations={
                                "ru": "Все существующие команды бота"
                            })
